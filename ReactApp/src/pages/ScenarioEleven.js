...
import { Box, Fade, Typography, Button, Table, TableBody, TableCell, TableContainer, TableHead, TableRow, Paper, LinearProgress, IconButton } from '@mui/material';
...
import questions from '../components/questions11'
...
function ScenarioEleven() {
  ...
  return (
    <div style={styles.scenario}>
      <Typography variant="h4" style={styles.title}>Prinzip 11: Schutz externer Schnittstellen</Typography>
