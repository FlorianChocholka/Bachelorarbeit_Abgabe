...
import questions from '../components/questions7'
...
function ScenarioSeven() {
  ...
  return (
    <div style={styles.scenario}>
      <Typography variant="h4" style={styles.title}>Prinzip 7: Sichere Softwareentwicklung</Typography>
