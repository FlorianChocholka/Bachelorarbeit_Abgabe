...
import questions from '../components/questions13'
...
function Scenario13() {
  ...
  return (
    <div style={styles.scenario}>
      <Typography variant="h4" style={styles.title}>Prinzip 13: Auditinformationen und Sicherheitswarnungen</Typography>
