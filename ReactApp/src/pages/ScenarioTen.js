...
import questions from '../components/questions10'
...
function ScenarioTen() {
  ...
  return (
    <div style={styles.scenario}>
      <Typography variant="h4" style={styles.title}>Prinzip 10: Identität und Authentifizierung</Typography>
