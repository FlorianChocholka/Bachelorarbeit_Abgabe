...
import questions from '../components/questions8'
...
function ScenarioEight() {
  ...
  return (
    <div style={styles.scenario}>
      <Typography variant="h4" style={styles.title}>Prinzip 8: Sicherheit der Lieferkette</Typography>
