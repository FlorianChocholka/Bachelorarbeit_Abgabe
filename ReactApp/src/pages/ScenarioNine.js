...
import questions from '../components/questions9'
...
function ScenarioNine() {
  ...
  return (
    <div style={styles.scenario}>
      <Typography variant="h4" style={styles.title}>Prinzip 9: Sicheres Benutzermanagement</Typography>
